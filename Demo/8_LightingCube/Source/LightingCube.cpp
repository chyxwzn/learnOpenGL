...
int main(int argc, char * argv[]) {
    ...
    while (glfwWindowShouldClose(mWindow) == false) {
        ...
        glUniform3f(glGetUniformLocation(objectShader.get(), "material.ambient"),  1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(objectShader.get(), "material.diffuse"),  1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(objectShader.get(), "material.specular"), 0.5f, 0.5f, 0.5f);
        glUniform1f(glGetUniformLocation(objectShader.get(), "material.shininess"),    32.0f);
        glBindVertexArray(VAO);
